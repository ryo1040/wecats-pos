    ...
    func setupViews() {
        ...
        if screenWidth < 668 { // 小さい画面の場合
            NSLayoutConstraint.activate([
                ...
                enterTimeTitleLabel.rightAnchor.constraint(equalTo: scrollView.leftAnchor, constant: 150),
                enterTimeTextField.centerYAnchor.constraint(equalTo: enterTimeTitleLabel.centerYAnchor),
                ...
                leftTimeTitleLabel.topAnchor.constraint(equalTo: enterTimeTitleLabel.bottomAnchor, constant: 24),
                leftTimeTitleLabel.rightAnchor.constraint(equalTo: enterTimeTitleLabel.rightAnchor),
                leftTimeTextField.centerYAnchor.constraint(equalTo: leftTimeTitleLabel.centerYAnchor),
                leftTimeTextField.leftAnchor.constraint(equalTo: leftTimeTitleLabel.rightAnchor, constant: 8),
                ...
                feeLabel.heightAnchor.constraint(equalToConstant: 25),
